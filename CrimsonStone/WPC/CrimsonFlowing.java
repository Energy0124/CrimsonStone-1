...
// Referenced classes of package com.github.Icyene.CrimsonStone.WaterproofCircuits:
//            Waterproof
...
public class CrimsonFlowing extends BlockFluids {
	...
	public void i(World world, int i, int j, int k) {
	...
	public void a(World world, int i, int j, int k, Random random) {
		...
		org.bukkit.block.Block source = bworld == null ? null : bworld
				.getBlockAt(i, j, k);
		int l = g(world, i, j, k);
		byte b0 = 1;
	...
	public void flow(World world, int i, int j, int k, int l) {
		if (l(world, i, j, k)) {
	...
	public int c(World world, int i, int j, int k, int l, int i1) {
		int j1 = 1000;
		for (int k1 = 0; k1 < 4; k1++)
			if ((k1 != 0 || i1 != 1) && (k1 != 1 || i1 != 0)
					&& (k1 != 2 || i1 != 3) && (k1 != 3 || i1 != 2)) {
				int l1 = i;
				int i2 = k;
				if (k1 == 0)
				...
				if (k1 == 3)
					i2++;
				if (!k(world, l1, j, i2)
						&& (world.getMaterial(l1, j, i2) != material || world
								.getData(l1, j, i2) != 0)) {
	...
	public boolean[] j(World world, int i, int j, int k) {
		...
		for (l = 0; l < 4; l++) {
			...
			if (l == 3)
				j1++;
			if (!k(world, i1, j, j1)
					&& (world.getMaterial(i1, j, j1) != material || world
							.getData(i1, j, j1) != 0))
	...
	public boolean k(World world, int i, int j, int k) {
		int l = world.getTypeId(i, j, k);
		if (!Waterproof.waterproofBlocks.contains(Integer.valueOf(l))
	...
	public boolean l(World world, int i, int j, int k) {
		Material material = world.getMaterial(i, j, k);
		return material == this.material ? false
				: material == Material.LAVA ? false : !k(world, i, j, k);
	}
